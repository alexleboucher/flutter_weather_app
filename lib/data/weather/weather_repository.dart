...
class WeatherRepository {
  WeatherRepository(
      {GeoProvider? geoProvider, WeatherProvider? weatherProvider})
      : _geoProvider = geoProvider ?? GeoProvider(),
  ...
  Future<Weather> getWeather(String city) async {
    final location = await _geoProvider.getLocation(city);
    final weather = await _weatherProvider.getWeather(
